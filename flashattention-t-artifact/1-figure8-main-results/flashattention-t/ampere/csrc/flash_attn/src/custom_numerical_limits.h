...
#ifndef USE_DEFAULT_NEGINF_MASK
#error "USE_DEFAULT_NEGINF_MASK must be defined"
#endif

#if USE_DEFAULT_NEGINF_MASK
constexpr float MASK_VALUE = -FP32_INFINITY;
#else
...
#if USE_DEFAULT_NEGINF_MASK
#define MASK_VALUE (-FP32_INFINITY)
#else
