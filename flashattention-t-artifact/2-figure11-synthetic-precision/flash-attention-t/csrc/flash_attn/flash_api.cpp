...
#define CUSTOM_DISALBE_FA_SPLITKV 1
#if !defined (CUSTOM_DISALBE_FA_SPLITKV)
#error CUSTOM_DISALBE_FA_SPLITKV must be defined to use this file
#endif
...
std::tuple<at::Tensor, at::Tensor> set_params_splitkv(Flash_fwd_params &params, const int batch_size,
    ...
    #else
    params.num_splits = 1;  // Force num_splits to 1
    #endif
